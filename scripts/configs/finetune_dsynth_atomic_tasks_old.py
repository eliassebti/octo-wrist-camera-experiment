...
def get_config(config_string="full,multimodal"):
    ...
    FINETUNING_KWARGS = {
        "name": "dsynth_atomic_tasks_builder",
        ...
        "action_normalization_mask": [True, True, True, True, True, True, True, False, True, True, True, True, True],
    ...
    config = dict(
        split='PickToCartStaticOneProdEnv+PickToCartOneProdEnv+NavMoveToZoneEnv+MoveFromBoardToBoardStaticOneProdEnv',
