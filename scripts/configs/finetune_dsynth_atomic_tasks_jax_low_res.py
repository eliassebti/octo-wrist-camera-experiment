...
def get_config(config_string="full,multimodal"):
    ...
    FINETUNING_KWARGS = {
        "name": "dsynth_atomic_tasks:1.1.0",
        ...
        "action_normalization_mask": [True, True, True, True, True, True, True, False, True, True, False, True, True],
        # standardize_fn is dynamically loaded from a file
        # for example: "experiments/kevin/custom_standardization_transforms.py:aloha_dataset_transform"
        "standardize_fn": ModuleSpec.create(
            "octo.data.oxe.oxe_standardization_transforms:move_from_board_to_board_static_env_builder_dataset_transform",
        ),
    ...
    config = dict(
        split="all",
        val_split='move_from_board_to_board_duff[99%:]',
    ...
    frame_transform_kwargs = dict(
        resize_size={
            "primary": (128, 128),  # workspace (3rd person) camera is at 128x128
            "secondary": (128, 128),
            "wrist": (64, 64),  # wrist camera is at 64x64
        },
